...
TEST_CASE( "size-of", "[type]" ) {
    CHECK( dl::sizeof_type( DLIS_FSHORT ) == 2 );
    CHECK( dl::sizeof_type( DLIS_FSINGL ) == 4 );
    CHECK( dl::sizeof_type( DLIS_FSING1 ) == 8 );
    CHECK( dl::sizeof_type( DLIS_FSING2 ) == 12 );
    CHECK( dl::sizeof_type( DLIS_ISINGL ) == 4 );
    CHECK( dl::sizeof_type( DLIS_VSINGL ) == 4 );
    CHECK( dl::sizeof_type( DLIS_FDOUBL ) == 8 );
    CHECK( dl::sizeof_type( DLIS_FDOUB1 ) == 16 );
    CHECK( dl::sizeof_type( DLIS_FDOUB2 ) == 24 );
    CHECK( dl::sizeof_type( DLIS_CSINGL ) == 8 );
    CHECK( dl::sizeof_type( DLIS_CDOUBL ) == 16 );
    CHECK( dl::sizeof_type( DLIS_SSHORT ) == 1 );
    CHECK( dl::sizeof_type( DLIS_SNORM  ) == 2 );
    CHECK( dl::sizeof_type( DLIS_SLONG  ) == 4 );
    CHECK( dl::sizeof_type( DLIS_USHORT ) == 1 );
    CHECK( dl::sizeof_type( DLIS_UNORM  ) == 2 );
    CHECK( dl::sizeof_type( DLIS_ULONG  ) == 4 );
    CHECK( dl::sizeof_type( DLIS_UVARI  ) == 0 );
    CHECK( dl::sizeof_type( DLIS_IDENT  ) == 0 );
    CHECK( dl::sizeof_type( DLIS_ASCII  ) == 0 );
    CHECK( dl::sizeof_type( DLIS_DTIME  ) == 8 );
    CHECK( dl::sizeof_type( DLIS_ORIGIN ) == 0 );
    CHECK( dl::sizeof_type( DLIS_OBNAME ) == 0 );
    CHECK( dl::sizeof_type( DLIS_OBJREF ) == 0 );
    CHECK( dl::sizeof_type( DLIS_ATTREF ) == 0 );
    CHECK( dl::sizeof_type( DLIS_STATUS ) == 1 );
    CHECK( dl::sizeof_type( DLIS_UNITS  ) == 0 );
}
