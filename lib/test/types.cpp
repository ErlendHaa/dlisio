...
TEST_CASE( "size-of", "[type]" ) {
    ...
    CHECK( dl::sizeof_type( rpc::fshort ) == 2 );
    CHECK( dl::sizeof_type( rpc::fsingl ) == 4 );
    CHECK( dl::sizeof_type( rpc::fsing1 ) == 8 );
    CHECK( dl::sizeof_type( rpc::fsing2 ) == 12 );
    CHECK( dl::sizeof_type( rpc::isingl ) == 4 );
    CHECK( dl::sizeof_type( rpc::vsingl ) == 4 );
    CHECK( dl::sizeof_type( rpc::fdoubl ) == 8 );
    CHECK( dl::sizeof_type( rpc::fdoub1 ) == 16 );
    CHECK( dl::sizeof_type( rpc::fdoub2 ) == 24 );
    CHECK( dl::sizeof_type( rpc::csingl ) == 8 );
    CHECK( dl::sizeof_type( rpc::cdoubl ) == 16 );
    CHECK( dl::sizeof_type( rpc::sshort ) == 1 );
    CHECK( dl::sizeof_type( rpc::snorm  ) == 2 );
    CHECK( dl::sizeof_type( rpc::slong  ) == 4 );
    CHECK( dl::sizeof_type( rpc::ushort ) == 1 );
    CHECK( dl::sizeof_type( rpc::unorm  ) == 2 );
    CHECK( dl::sizeof_type( rpc::ulong  ) == 4 );
    CHECK( dl::sizeof_type( rpc::uvari  ) == 0 );
    CHECK( dl::sizeof_type( rpc::ident  ) == 0 );
    CHECK( dl::sizeof_type( rpc::ascii  ) == 0 );
    CHECK( dl::sizeof_type( rpc::dtime  ) == 8 );
    CHECK( dl::sizeof_type( rpc::origin ) == 0 );
    CHECK( dl::sizeof_type( rpc::obname ) == 0 );
    CHECK( dl::sizeof_type( rpc::objref ) == 0 );
    CHECK( dl::sizeof_type( rpc::attref ) == 0 );
    CHECK( dl::sizeof_type( rpc::status ) == 1 );
    CHECK( dl::sizeof_type( rpc::units  ) == 0 );
}
