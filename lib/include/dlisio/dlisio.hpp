...
constexpr int SIZEOF_VRL = 4;
int vrl( const char* xs,
         int* len,
         int* version );

/* logical-record-segment-header */
constexpr int SIZEOF_LRSH = 4;
...
constexpr int SIZEOF_DESCRIPTOR = 1;
 ...
 * to the DLIS_SIZEOF constants in dlisio/types.hpp
 *
 * NOTE:
