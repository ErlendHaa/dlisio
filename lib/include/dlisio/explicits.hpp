#ifndef DLISIO_EXPLICITS_HPP
#define DLISIO_EXPLICITS_HPP
...
using value_vector = mpark::variant<
    mpark::monostate,
    std::vector< dl::fshort >,
    std::vector< dl::fsingl >,
    std::vector< dl::fsing1 >,
    std::vector< dl::fsing2 >,
    std::vector< dl::isingl >,
    std::vector< dl::vsingl >,
    std::vector< dl::fdoubl >,
    std::vector< dl::fdoub1 >,
    std::vector< dl::fdoub2 >,
    std::vector< dl::csingl >,
    std::vector< dl::cdoubl >,
    std::vector< dl::sshort >,
    std::vector< dl::snorm  >,
    std::vector< dl::slong  >,
    std::vector< dl::ushort >,
    std::vector< dl::unorm  >,
    std::vector< dl::ulong  >,
    std::vector< dl::uvari  >,
    std::vector< dl::ident  >,
    std::vector< dl::ascii  >,
    std::vector< dl::dtime  >,
    std::vector< dl::origin >,
    std::vector< dl::obname >,
    std::vector< dl::objref >,
    std::vector< dl::attref >,
    std::vector< dl::status >,
    std::vector< dl::units  >
>;
...
struct object_attribute {
    ...
    dl::representation_code reprc = dl::representation_code::ident;
    dl::units           units = {};
