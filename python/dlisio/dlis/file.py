...
class logicalfile(object):
    ...
    def find(self, objecttype, objectname=None, matcher=None):
        ...
        dlisio.dlis.util.exact_matcher : str comparison w/ str.__eq__
        dlisio.dlis.util.regex_matcher : str comparison w/ python's re module
        ...
        >>> f.find('FRAME', matcher=dlisio.common.exact)
        [Frame(60B), Frame(20B), Frame(10B)]
        """
        if not matcher:
            matcher = regex
